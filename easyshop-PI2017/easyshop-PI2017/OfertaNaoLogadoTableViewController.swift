//
//  OfertaNaoLogadoTableViewController.swift
//  easyshop-PI2017
//
//  Created by uillian on 22/11/2017.
//  Copyright © 2017 uillian. All rights reserved.
//

import UIKit

class OfertaNaoLogadoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        /*  produto = Produ(titulo: "Feijão Carioca", descricao: "R$ 5,28   -12% off", imagem: #imageLiteral(resourceName: "produto3"))
         mercadorias.append( produto )
         
         produto = Produ(titulo: "Cookies", descricao: "R$ 2,99  -12% off", imagem: #imageLiteral(resourceName: "produto4"))
         mercadorias.append( produto )
        ...
        produto = Produ(titulo: "Cerveja Brahma", descricao: "R$ 2,46  -12% off", imagem: #imageLiteral(resourceName: "cerveja Brahma"))
        mercadorias.append( produto )
        
        // produto = Produ(titulo: "Cerveja Skol", descricao: "R$ 2,64", imagem: #imageLiteral(resourceName: "cerveja skol"))
        // mercadorias.append( produto )
        
        produto = Produ(titulo: "Coca Cola 2L", descricao: "R$ 5,19  -12% off", imagem: #imageLiteral(resourceName: "coca 2L"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Pinho Sol", descricao: "R$ 7,74  -12% off", imagem: #imageLiteral(resourceName: "desinfetante"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Bombom Garoto", descricao: "R$ 7,12  -12% off", imagem: #imageLiteral(resourceName: "garoto"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Iorgute", descricao: "R$ 2,28  -12% off", imagem: #imageLiteral(resourceName: "iorgute"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Leite Cemil", descricao: "R$ 1,80  -12% off", imagem: #imageLiteral(resourceName: "leite cemil"))
        mercadorias.append( produto )
        ...
        produto = Produ(titulo: "Suco Tang", descricao: "R$ 0,78   -12% off", imagem: #imageLiteral(resourceName: "suco tang"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Toddy", descricao: "R$ 7,30   -12% off", imagem: #imageLiteral(resourceName: "toddy"))
        mercadorias.append( produto )
        
        produto = Produ(titulo: "Vinagre", descricao: "R$ 2,81  -12% off", imagem: #imageLiteral(resourceName: "vinagre"))
        mercadorias.append( produto )
